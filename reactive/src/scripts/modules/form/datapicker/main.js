...
(function (factory) {
    ...
    var Datepicker = function (element, options) {
        ...
        if (this.o.calendarWeeks)
            this.picker.find('thead .bs-datepicker-title, tfoot .today, tfoot .clear')
    ...
    Datepicker.prototype = {
        ...
        place: function () {
            ...
            this.picker.removeClass(
                'bs-datepicker-orient-top bs-datepicker-orient-bottom ' +
                'bs-datepicker-orient-right bs-datepicker-orient-left'
            );
        ...
        fillDow: function () {
            var dowCnt = this.o.weekStart,
                html = '<tr>';
            if (this.o.calendarWeeks) {
                this.picker.find('.bs-datepicker-days .bs-datepicker-switch')
                    .attr('colspan', function (i, val) {
                        return parseInt(val) + 1;
                    });
                html += '<th class="cw">&#160;</th>';
        ...
        fill: function () {
            ...
            this.picker.find('thead .bs-datepicker-title')
                .text(this.o.title)
                .toggle(this.o.title !== '');
            this.updateNavArrows();
            this.fillMonths();
            ...
            var months = this.picker.find('.bs-datepicker-months')
                .find('.bs-datepicker-switch')
        ...
        showMode: function (dir) {
            ...
            this.picker
                .children('div')
                .hide()
                .filter('.bs-datepicker-' + DPGlobal.modes[this.viewMode].clsName)
                .show();
            this.updateNavArrows();
        }
    };
    ...
    var locale_opts = $.fn.bsDatepicker.locale_opts = [
        'format',
        'rtl',
        'weekStart'
    ];
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
        '<tr>' +
        '<th colspan="7" class="bs-datepicker-title"></th>' +
        '</tr>' +
        '<tr>' +
        '<th class="prev">&laquo;</th>' +
        '<th colspan="5" class="bs-datepicker-switch"></th>' +
    ...
    DPGlobal.template = '<div class="bs-datepicker">' +
        '<div class="bs-datepicker-days">' +
        ...
        '</table>' +
        '</div>' +
        '<div class="bs-datepicker-months">' +
        '<table class="table-condensed">' +
        DPGlobal.headTemplate +
        ...
        '</table>' +
        '</div>' +
        '<div class="bs-datepicker-decades">' +
        '<table class="table-condensed">' +
        DPGlobal.headTemplate +
        DPGlobal.contTemplate +
        DPGlobal.footTemplate +
        '</table>' +
        '</div>' +
        '<div class="bs-datepicker-centuries">' +
        '<table class="table-condensed">' +
        DPGlobal.headTemplate +
        DPGlobal.contTemplate +
        DPGlobal.footTemplate +
    ...
    * ================== */
    ...
    $(document).on(
        'focus.bs-datepicker.data-api click.bs-datepicker.data-api',
        '[data-provide="bs-datepicker"]',
        function (e) {
            var $this = $(this);
            if ($this.data('bsDatepicker'))
                return;
            e.preventDefault();
